  ...
  render() {
    ...
    return(
      <div className="info-side container" align="center" >
        <br/>
        <h2 class="white-text">Congratualations {firstName}, you have completed the experiment. Our goal with this information is to better understand the impact technology can have on stroke diagnoses.
        If you have any further questions feel free to contact Andrew Nguyen (adn047@ucsd.edu) or Vishwajith Ramesh (vramesh@eng.ucsd.edu).</h2>
        <br/><br/>
